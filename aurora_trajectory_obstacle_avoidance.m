...
t_an(:,:,3) = [linspace(0.25,0.5,20);linspace(0.3,0.3,20);linspace(0.6,0.6,20);linspace(-0.2,-0.2,20);linspace(0,0,20)];
t_an(:,:,4) = [linspace(0.5,0.4,20);linspace(0.3,0.3,20);linspace(0.6,0.3,20);linspace(-0.2,-0.2,20);linspace(0,0,20)];

t_an(:,:,5) = [linspace(0.4,-0.25,20);linspace(0.3,0.7,20);linspace(0.3,0.28,20);linspace(-0.2,-0.21,20);linspace(0,0.5,20)];
t_an(:,:,6) = [linspace(-0.25,0.3,20);linspace(0.7,0,20);linspace(0.28,0.3,20);linspace(-0.21,0,20);linspace(0.5,0,20)];
pause(2);
...
for count = 1:6
    for pos = 1:20
        ...
        %----Obstacle-------------%
        plot3([-100 -100],[-103 -103],[-100 50],'linewidth',5);
